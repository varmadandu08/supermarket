...
class PriceCalculationServiceTest {
    ...
    void priceCalculationServiceProvidesCorrectPriceCalculations(String description, String expectedTotal, Iterable<Item> items) {
        final Basket basket = new Basket();
        items.forEach(basket::add);
        assertEquals(new BigDecimal(expectedTotal), new PriceCalculationServiceImpl(basket).calculatePrice());
    }
